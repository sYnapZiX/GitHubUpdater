...
Public Class GitHubUpdater
    ...
    End Structure
    Structure Asyncronous
        Public Shared Sub DownloadProgressAsync(sender As Object, e As DownloadProgressChangedEventArgs)
            '###############################
            '###############################
            '### PUT YOUR UI CODE BELOW HERE
            '###############################
            '###############################

        End Sub
        Public Shared Sub DownloadFinishedAsync(sender As Object, e As AsyncCompletedEventArgs)
            ...
            End If
        End Sub
        Public Shared Sub DownloadAsync(Optional ExecutableToMove As String = "")
            Try
                If My.Computer.Network.Ping("www.github.com", Properties.Timeout) Then
                    ...
                    Using UpdateClient As New WebClient
                        ...
                        Dim DownloadTarget As String = Properties.TemporaryFolder & "\" & Properties.AssetFile
                        AddHandler UpdateClient.DownloadProgressChanged, AddressOf DownloadProgressAsync
                        AddHandler UpdateClient.DownloadFileCompleted, AddressOf DownloadFinishedAsync
